...
namespace backend.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        //Now we have access to the DB, Create the CRUD methods

        //Create (IActionResult will not return anything)
        [HttpPost]
        ...
        {
            var products = await _context.Products.OrderByDescending(x => x.UpdatedAt).ToListAsync();
